...
\textit{Task 3.} was designed with very sparse rewards \citep{Mniha,Silver2016b,Silver2018}. There were 10 choices. The best choice had a payout of $p(R=1) = 0.02$. The other nine had, $p(R=1) = 0.01$ for all others. See Fig.~\ref{fig:payout}\textbf{c}. 
